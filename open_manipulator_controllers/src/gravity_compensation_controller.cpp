...
void GravityCompensationController::planning_trajectory(double current_time) {
...
void GravityCompensationController::transformKDLToEigen(const KDL::Frame& k,
                                                        Eigen::Affine3d& e) {
  // KDL::Vector v;
  // KDL::SetToZero(v);
...
void GravityCompensationController::twistKDLToEigen(
