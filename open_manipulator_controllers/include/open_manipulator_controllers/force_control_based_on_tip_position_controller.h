...
#ifndef OPEN_MANIPULATOR_CONTROLLERS_FORCE_CONTROL_BASED_ON_TIP_POSITION_CONTROLLER_H
#define OPEN_MANIPULATOR_CONTROLLERS_FORCE_CONTROL_BASED_ON_TIP_POSITION_CONTROLLER_H
...
class ForceControlBasedOnTipPositionController
 ...
 private:
  ...
  KDL::Twist target_vel_;
  KDL::Twist target_acc_;
  ...
  boost::scoped_ptr<KDL::ChainFkSolverPos_recursive> FK_solver_pos_;
...
#endif  // OPEN_MANIPULATOR_CONTROLLERS_FORCE_CONTROL_BASED_ON_TIP_POSITION_CONTROLLER_H
